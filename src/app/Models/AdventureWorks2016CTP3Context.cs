...
{
    public partial class AdventureWorks2016CTP3Context : DbContext
    {
        public AdventureWorks2016CTP3Context()
        {
        }

        public AdventureWorks2016CTP3Context(DbContextOptions<AdventureWorks2016CTP3Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=LAPTOP-47RLMI1E;Database=AdventureWorks2016CTP3;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderTracking>(entity =>
            {
                ...
                entity.Property(e => e.TrackingEventId).HasColumnName("TrackingEventID");
            });
            ...
            modelBuilder.Entity<SalesOrderDetailInmem>(entity =>
            {
                ...
                entity.HasOne(d => d.SalesOrder)
                    .WithMany(p => p.SalesOrderDetailInmem)
                    .HasForeignKey(d => d.SalesOrderId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("IMFK_SalesOrderDetail_SalesOrderHeader_SalesOrderID");

                entity.HasOne(d => d.SpecialOfferProductInmem)
                    .WithMany(p => p.SalesOrderDetailInmem)
                    .HasForeignKey(d => new { d.SpecialOfferId, d.ProductId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<SalesOrderDetailOndisk>(entity =>
            {
                ...
                entity.HasOne(d => d.SalesOrder)
                    .WithMany(p => p.SalesOrderDetailOndisk)
                    .HasForeignKey(d => d.SalesOrderId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ODFK_SalesOrderDetail_SalesOrderHeader_SalesOrderID");

                entity.HasOne(d => d.SpecialOfferProductOndisk)
                    .WithMany(p => p.SalesOrderDetailOndisk)
                    .HasForeignKey(d => new { d.SpecialOfferId, d.ProductId })
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<SpecialOfferProductInmem>(entity =>
            {
                ...
                entity.HasOne(d => d.Product)
                    .WithMany(p => p.SpecialOfferProductInmem)
                    .HasForeignKey(d => d.ProductId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<SpecialOfferProductOndisk>(entity =>
            {
                ...
                entity.HasOne(d => d.Product)
                    .WithMany(p => p.SpecialOfferProductOndisk)
                    .HasForeignKey(d => d.ProductId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
